    ...
    if (selectedStudents.includes(id)) {
      ...
      if (selectedStudents.length === 0) {
        ...
        if (studentFees.length > 0) {
          setPreviewAmount(studentFees[0].balance);
          ...
          <div className="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-100 hover:shadow-xl transition-shadow duration-300">
            ...
            <div className="p-4 space-y-4">
              ...
              <div className="space-y-4">
                ...
                <div className="max-h-72 overflow-y-auto border-2 border-gray-200 rounded-xl bg-white shadow-sm">
                ...
                <table className="min-w-full divide-y divide-gray-200">
                  ...
                  <tbody className="bg-white divide-y divide-gray-100">
                    {messages.slice().reverse().map((message, idx) => (
                      <tr key={message.id || idx} className="hover:bg-gray-50 transition-colors duration-200 group">
              ...
              <div className="p-4 bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-lg shadow-sm">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div className="flex bg-white rounded-lg border border-gray-200">
                    <button 
                      ...
                      onClick={() => {
                        if (selectedStudentFees.length > 0) {
                          setSelectedStudentInstallments([]);
                          setPreviewAmount(selectedStudentFees[0].balance);
                    ...
                    <button 
                      className={`px-3 py-2 text-sm font-medium transition-colors ${
                        selectedStudentInstallments.length > 0 && selectedStudentFees.length === 0 
                  ...
                  <div className="mb-3">
                    ...
                    <div className="grid grid-cols-1 gap-2 max-h-32 overflow-y-auto">
                      {selectedStudentFees.map(fee => (
                        ...
                        >
                          <span className="text-sm font-medium text-gray-800">{fee.feeType}</span>
                      ...
                      {selectedStudentInstallments.map(inst => (
                        ...
                        >
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-sm font-medium text-gray-800">{inst.feeType}</span>
                          </div>
