...
const Students = () => {
    ...
    try {
      ...
      const rows = filteredStudents.map(student => {
        ...
        return [
          ...
          escapeCSVField(student.englishName || ''),
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-br from-blue-50/80 via-slate-50/60 to-gray-50/40 rounded-lg p-6 border border-gray-200/50 shadow-lg shadow-gray-300/20">
      ...
      <div className="my-6 flex flex-col md:flex-row md:items-center gap-4">
        <div className="flex-1">
          <div className="relative">
            <input
              type="text"
              placeholder="بحث عن طالب..."
              className="w-full p-2 pr-10 border border-gray-300 rounded focus:border-[#800000] focus:ring-[#800000]"
              value={searchTerm}
        ...
        <div className="w-full md:w-auto">
          <select
            className="w-full p-2 border border-gray-300 rounded focus:border-[#800000] focus:ring-[#800000]"
            value={gradeFilter}
      ...
      {/* Students Table */}
      <div className="overflow-x-auto bg-white rounded-lg shadow-xl shadow-[#800000]/15 border border-[#800000]/10">
            ...
            {Array.from({ length: totalPages }, (_, i) => i + 1).map((page) => (
              <button
                ...
                className={`mx-1 px-3 py-1 rounded ${
                  currentPage === page ? 'bg-[#800000] text-white' : 'bg-gray-200 hover:bg-gray-300'
                }`}
              >
                {page}
              </button>
