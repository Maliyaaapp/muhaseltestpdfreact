...
-- Drop existing schools policies if they exist
...
-- Drop existing students policies if they exist
...
-- Drop existing fees policies if they exist
...
-- Drop existing installments policies if they exist
...
-- Drop existing templates policies if they exist
...
-- Drop existing API keys policies if they exist
DROP POLICY IF EXISTS "Admins can view all API keys" ON api_keys;
DROP POLICY IF EXISTS "School admins can view their school API keys" ON api_keys;
