...
export const exportReceiptToPDF = async (
  ...
  try {
    ...
    const htmlContent = await generateReceiptHTML(data);
 ...
 */
export const generateReceiptExportHTML = async (data: ReceiptData): Promise<string> => {
  ...
  return await generateReceiptHTML(data);
}; 